package _1Fundamentals.UnionFind;
...
public class WeightedQuickUnionUF {
    ...
    public static void main(String[] args) {
        UFUtils.UFDataHolder h = UFUtils.getUFList(2);

        StdOut.println("Start QUF");
        StopwatchCPU c = new StopwatchCPU();
        WeightedQuickUnionUF uf = new WeightedQuickUnionUF(h.N);
        int[] ints = h.ints;
        ...
        StdOut.println("timeUsed : " + c.elapsedTime());
    }
