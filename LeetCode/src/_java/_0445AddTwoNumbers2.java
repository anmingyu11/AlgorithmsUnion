 ...
 * Output: 7 -> 8 -> 0 -> 7
 */
public class _0445AddTwoNumbers2 extends BaseLinkedList {
    ...
    public static void main(String[] args) {
        ...
        ListNode<Integer> res = s.addTwoNumbers(
                generateASingleListNode(new int[]{7, 2, 4, 3}),
                generateASingleListNode(new int[]{5, 6, 4})
        );
